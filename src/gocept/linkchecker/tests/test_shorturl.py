...
from Products.CMFLinkChecker.shorturls import shortURL
...
class ShortURLTest(TestCase):
    ...
    def testPathFolding(self):
        ...
        url = "http://www.gocept.com/angebot/opensource/CMFLinkChecker/revision1.3"
    ...
    def testPriorityFolding(self):
        ...
        url = "http://www.gocept.com/angebot/opensource/CMFLinkChecker/revision1.3;asdf?query=1#fragment"
        
        self.assertEqual(shortURL(url, 84), 
              "http://www.gocept.com/angebot/opensource/CMFLinkChecker/revision1.3;asdf?query=1#...")

        self.assertEqual(shortURL(url, 80), 
              "http://www.gocept.com/angebot/opensource/CMFLinkChecker/revision1.3;asdf?...#...")
